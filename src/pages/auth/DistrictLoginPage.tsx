...
export default function DistrictLoginPage() {
  ...
  return (
    <div className="min-h-screen">
      <PageHero title={t('login.districtTitle')} subtitle={t('login.districtSubtitle')} />
      <div className="container-wide max-w-md py-10">
        <motion.div {...popIn} className="surface-card p-6">
          <div className="mb-6 flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-royal-700 text-white shadow-sm">
              <Shield className="h-6 w-6" />
            </div>
            <div>
              <p className="font-bold text-neutral-900">District Incharge</p>
              <p className="text-sm text-neutral-600">Sign in with your district office credentials</p>
            </div>
          </div>
